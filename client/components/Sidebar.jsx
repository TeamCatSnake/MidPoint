    ...
    <div id="sidebar" className="sidebarStyles">
      <div id="user-info" style={{ borderBottom: "1px solid black" }}>
        <div className="flexAlignCenter">
          ...
          <p id="welcomeText" className="pStyles">
      ...
      <div id="friend-list" className="center">
        ...
        {console.log("Props friends list", props.friendsList)}{" "}
        {/* array of objects with user_id, username, and coordinates properties*/}
        <div className="inputStyles">
          {props.friendsList.map((friend) => {
            return (
              ...
              >
                <button
                  id="findMidpointButton"
                  onClick={() =>
                    props.getMidpoint(props.userCoords, friend.coordinates)
                  }
                >
                  {friend.username}
                </button>
      ...
      <div id="futureFriendsList" className="center">
        <p>Future Friends: </p>
        <div className="inputStyles" className="center">
          {props.notFriendsList.map((notFriend, i) => {
            return (
              <div
                id={notFriend.user_id}
                key={notFriend.user_id}
                value={notFriend.username}
              >
                <button
                  onClick={() =>
                    props.addFriend(props.userID, notFriend.user_id)
                  }
                >
                  {notFriend.username}
                </button>
